...
import { MagnifyingGlassIcon, TicketIcon, UserCircleIcon, ChevronDownIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
              ...
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 pl-4 border-l border-gray-300 hover:text-primary-600 transition"
                  >
